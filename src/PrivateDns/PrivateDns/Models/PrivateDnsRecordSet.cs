// ------------------------------------------------------------------------------------------------
// <copyright file="PrivateDnsRecordSet.cs" company="Microsoft Corporation">
...
namespace Microsoft.Azure.Commands.PrivateDns.Models
{
    ...
    /// </summary>
    public class PrivateDnsRecordSet : ICloneable
    {
        /// <summary>
        ...
        public object Clone()
        {
            var clone = new PrivateDnsRecordSet
            {
                Name = this.Name,
    ...
    /// <summary>
    /// Represents a Private DNS record that is part of a <see cref="PrivateDnsRecordSet"/>.
    /// </summary>
    ...
    /// <summary>
    /// Represents a Private DNS record of type A that is part of a <see cref="PrivateDnsRecordSet"/>.
    /// </summary>
    ...
    /// <summary>
    /// Represents a Private DNS record of type AAAA that is part of a <see cref="PrivateDnsRecordSet"/>.
    /// </summary>
    ...
    /// <summary>
    /// Represents a Private DNS record of type CNAME that is part of a <see cref="PrivateDnsRecordSet"/>.
    /// </summary>
    ...
    /// <summary>
    /// Represents a Private DNS record of type TXT that is part of a <see cref="PrivateDnsRecordSet"/>.
    /// </summary>
