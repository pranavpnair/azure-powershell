...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dns/Remove-AzPrivateDnsZone
schema: 2.0.0
---
...
### Fields
```
Remove-AzPrivateDnsZone -Name <String> -ResourceGroupName <String> [-PassThru]
...
### -Zone
Specifies the private DNS zone to delete.
